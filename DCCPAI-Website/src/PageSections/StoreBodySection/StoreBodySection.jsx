    ...
    <div className={styles.storeBodyContainer}>
        <div className={styles.storeBodyLeft}>
            ...
            <div>
                ...
                {categories.filter(category => category.product_isCacao).length > 0 ? (
                    <ul>
                        {categories.filter(category => category.product_isCacao).map(category => (
                            <a key={category.category_id} onClick={() => handleCategoryChange(category.category_id)}>
                ...
                <button onClick={() => handleCacaoCategoryChange(true)}>Show All Cacao</button>
            </div>
            ...
            <div>
                ...
                <button onClick={() => handleCacaoCategoryChange(false)}>Show All Non-Cacao</button>
            </div>
            ...
            <div>
                <h2>Brand</h2>
                    {brands.length > 0 ? (
                        <ul>
                            {brands.map(brand => (
                                <a key={brand.product_owner_id} onClick={() => handleBrandChange(brand.product_owner_name)}>
